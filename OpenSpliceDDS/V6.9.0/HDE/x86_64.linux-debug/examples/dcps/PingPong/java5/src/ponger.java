...
public class ponger {
    ...
    public void run (String args[]) {
        try {
            ...
            /* Create datawriter */
            PP_min_writer = p.createDataWriter(PP_min_topic);

            /* Create datareader */
            PP_min_reader = s.createDataReader(PP_min_topic);
            ...
            /* Create datawriter */
            PP_seq_writer = p.createDataWriter(PP_seq_topic);

            /* Create datareader */
            PP_seq_reader = s.createDataReader(PP_seq_topic);
            ...
            /* Create datawriter */
            PP_string_writer = p.createDataWriter(PP_string_topic);

            /* Create datareader */
            PP_string_reader = s.createDataReader(PP_string_topic);
            ...
            /* Create datawriter */
            PP_fixed_writer = p.createDataWriter(PP_fixed_topic);

            /* Create datareader */
            PP_fixed_reader = s.createDataReader(PP_fixed_topic);
            ...
            /* Create datawriter */
            PP_array_writer = p.createDataWriter(PP_array_topic);

            /* Create datareader */
            PP_array_reader = s.createDataReader(PP_array_topic);
            ...
            /* Create datawriter */
            PP_quit_reader = s.createDataReader(PP_quit_topic);
            /* Add datareader statuscondition to waitset */
