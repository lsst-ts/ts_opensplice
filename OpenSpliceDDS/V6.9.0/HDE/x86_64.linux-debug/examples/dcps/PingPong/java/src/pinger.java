...
class pinger {
    ...
    private int                             myDomain = DOMAIN_ID_DEFAULT.value;
            ...
            while (!finish_flag) {
                ...
                if (!terminate) {
                    ...
                    while (!(timeout_flag || finish_flag)) {
                        ...
                        if(result == DDS.RETCODE_OK.value || result == DDS.RETCODE_NO_DATA.value || result == DDS.RETCODE_TIMEOUT.value)
                        {
                        ...
                        {
                            System.out.println ("PING: Waitset wait failed (code "+result+"), terminating.");
                            finish_flag = true;
                            terminate = true;
                        }
                    }
