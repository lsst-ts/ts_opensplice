...
OS_API sd_serializer sd_serializerXMLNew(c_base base) __nonnull_all__ __attribute_warn_unused_result__;
OS_API sd_serializer sd_serializerXMLNewTyped(c_type type) __nonnull_all__ __attribute_warn_unused_result__;
