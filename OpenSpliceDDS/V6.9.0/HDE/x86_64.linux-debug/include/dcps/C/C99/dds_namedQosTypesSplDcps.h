...
extern  v_copyin_result __DDS_NamedDomainParticipantQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_NamedPublisherQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_NamedSubscriberQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_NamedTopicQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_NamedDataWriterQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_NamedDataReaderQos__copyIn(c_base base, const void *from, void *to);
