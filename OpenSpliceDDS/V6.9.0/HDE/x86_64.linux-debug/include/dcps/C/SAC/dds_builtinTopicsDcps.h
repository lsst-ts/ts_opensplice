...
typedef DDS_long DDS_BuiltinTopicKey_t[3];
typedef DDS_long DDS_BuiltinTopicKey_t_slice;
 DDS_BuiltinTopicKey_t_slice *DDS_BuiltinTopicKey_t__alloc (void);

#define DDS_sequence_string__alloc DDS_sequence_string__alloc
#define DDS_sequence_string_allocbuf DDS_sequence_string_allocbuf
