...
struct _DDS_Time_t ;
extern  v_copyin_result __DDS_Time_t__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_SchedulingClassQosPolicy__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_SchedulingPriorityQosPolicy__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_SchedulingQosPolicy__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_ViewKeyQosPolicy__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_DataReaderViewQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_DomainParticipantFactoryQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_DomainParticipantQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_TopicQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_DataWriterQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_PublisherQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_DataReaderQos__copyIn(c_base base, const void *from, void *to);
...
extern  v_copyin_result __DDS_SubscriberQos__copyIn(c_base base, const void *from, void *to);
