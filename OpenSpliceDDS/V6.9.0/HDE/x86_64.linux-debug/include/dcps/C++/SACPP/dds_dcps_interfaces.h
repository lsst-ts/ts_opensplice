...
namespace DDS
{
   ...
   class OS_API ExtDomainParticipantListener;
   ...
   class OS_API ErrorInfoInterface;
   ...
   private:
    ...
    class OS_API PropertyInterface;
   ...
   public:
      ...
      virtual ReturnCode_t delete_historical_data (const DDS::Char* partition_expression, const DDS::Char* topic_expression) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t delete_contained_entities () = 0;
      virtual ReturnCode_t detach_all_domains (DDS::Boolean block_operations, DDS::Boolean delete_entities) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t get_all_data_disposed_topic_status (AllDataDisposedTopicStatus& a_status) = 0;
   ...
   public:
      ...
      virtual ReturnCode_t get_code (ReturnCode_t& code) = 0;
