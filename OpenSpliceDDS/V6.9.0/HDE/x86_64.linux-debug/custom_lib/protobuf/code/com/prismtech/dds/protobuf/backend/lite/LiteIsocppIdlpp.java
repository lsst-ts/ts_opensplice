 ...
 */
package com.prismtech.dds.protobuf.backend.lite;
...
public class LiteIsocppIdlpp implements Idlpp {

    @Override
    public String[] getIdlCommand(File idlFile, MetaFile metadata)
            throws ProtoParseException {
        // TODO Implement method that returns the IDL pre-processor command
        // plus all its command-line options to generate isocpp code for Lite.
        throw new ProtoParseException("Not implemented yet.");
    }
}
