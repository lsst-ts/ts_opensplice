...
ShapeTypeTypeSupportFactory::create_view (gapi_dataReaderView handle)
{
    return new ShapeTypeDataReaderView_impl (handle);
}
...
ShapeTypeTypeSupport::ShapeTypeTypeSupport(void) :
    TypeSupport_impl(
        ...
        ShapeTypeTypeSupport::metaDescriptorArrLength)
{
...
) : ::DDS::DataReader_impl(handle, ::DDS::ccpp_DataReaderParallelDemarshallingMain<ShapeTypeSeq>)
{
    // Parent constructor takes care of everything.
}
...
// DDS ShapeType DataReaderView_impl Object Body

ShapeTypeDataReaderView_impl::ShapeTypeDataReaderView_impl (
...
ShapeTypeDataReaderView_impl::~ShapeTypeDataReaderView_impl(void)
{
    // Parent destructor takes care of everything.
}
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
    ...
    ::DDS::InstanceStateMask instance_states) THROW_ORB_EXCEPTIONS
{
    ...
    status = ShapeTypeDataReader_impl::check_preconditions(received_data, info_seq, max_samples);
    if ( status == ::DDS::RETCODE_OK ) {
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read_w_condition(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take_w_condition(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read_next_sample(
    ShapeType & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take_next_sample(
    ShapeType & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read_instance(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take_instance(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read_next_instance(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take_next_instance(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::read_next_instance_w_condition(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::take_next_instance_w_condition(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::return_loan(
    ShapeTypeSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq) THROW_ORB_EXCEPTIONS
{
    ::DDS::ReturnCode_t status = ::DDS::RETCODE_OK;
...
::DDS::ReturnCode_t
ShapeTypeDataReaderView_impl::get_key_value(
    ShapeType & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
ShapeTypeDataReaderView_impl::lookup_instance(
    const ShapeType & instance) THROW_ORB_EXCEPTIONS
{
...
const char * ShapeTypeTypeSupport::metaDescriptor[] = {"<MetaData version=\"1.0.0\"><Struct name=\"ShapeType\"><Member name=\"color\"><String/></Member><Member name=\"x\">",
"<Long/></Member><Member name=\"y\"><Long/></Member><Member name=\"shapesize\"><Long/></Member></Struct>",
"</MetaData>"};
const ::DDS::ULong (ShapeTypeTypeSupport::metaDescriptorArrLength) = 3;
