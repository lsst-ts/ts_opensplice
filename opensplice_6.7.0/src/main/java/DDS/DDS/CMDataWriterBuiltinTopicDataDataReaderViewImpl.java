...
public class CMDataWriterBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CMDataWriterBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private CMDataWriterBuiltinTopicDataTypeSupport typeSupport;

    public CMDataWriterBuiltinTopicDataDataReaderViewImpl(DDS.CMDataWriterBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
