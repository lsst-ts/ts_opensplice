...
public class CMPublisherBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CMPublisherBuiltinTopicDataDataWriter
{
    private long copyCache;
    private CMPublisherBuiltinTopicDataTypeSupport typeSupport;

    public CMPublisherBuiltinTopicDataDataWriterImpl(DDS.CMPublisherBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
