...
public class CMSubscriberBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CMSubscriberBuiltinTopicDataDataWriter
{
    private long copyCache;
    private CMSubscriberBuiltinTopicDataTypeSupport typeSupport;

    public CMSubscriberBuiltinTopicDataDataWriterImpl(DDS.CMSubscriberBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            DDS.CMSubscriberBuiltinTopicData instance_data)
    {
        long uWriter = 0;
