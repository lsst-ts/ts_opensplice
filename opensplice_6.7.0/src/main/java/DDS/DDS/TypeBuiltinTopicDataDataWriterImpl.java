...
public class TypeBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TypeBuiltinTopicDataDataWriter
{
    private long copyCache;
    private TypeBuiltinTopicDataTypeSupport typeSupport;

    public TypeBuiltinTopicDataDataWriterImpl(DDS.TypeBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
