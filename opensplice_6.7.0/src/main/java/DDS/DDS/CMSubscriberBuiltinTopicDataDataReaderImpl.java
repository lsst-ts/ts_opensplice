...
public class CMSubscriberBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CMSubscriberBuiltinTopicDataDataReader
{
    private long copyCache;
    private CMSubscriberBuiltinTopicDataTypeSupport typeSupport;

    public CMSubscriberBuiltinTopicDataDataReaderImpl(DDS.CMSubscriberBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new CMSubscriberBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
