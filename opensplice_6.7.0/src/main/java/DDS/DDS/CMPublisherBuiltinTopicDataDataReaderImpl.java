...
public class CMPublisherBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CMPublisherBuiltinTopicDataDataReader
{
    private long copyCache;
    private CMPublisherBuiltinTopicDataTypeSupport typeSupport;

    public CMPublisherBuiltinTopicDataDataReaderImpl(DDS.CMPublisherBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new CMPublisherBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
