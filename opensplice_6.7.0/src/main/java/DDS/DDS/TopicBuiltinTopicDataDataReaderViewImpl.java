...
public class TopicBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements TopicBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private TopicBuiltinTopicDataTypeSupport typeSupport;

    public TopicBuiltinTopicDataDataReaderViewImpl(DDS.TopicBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
