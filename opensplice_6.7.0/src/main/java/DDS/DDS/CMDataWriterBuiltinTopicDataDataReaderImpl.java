...
public class CMDataWriterBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CMDataWriterBuiltinTopicDataDataReader
{
    private long copyCache;
    private CMDataWriterBuiltinTopicDataTypeSupport typeSupport;

    public CMDataWriterBuiltinTopicDataDataReaderImpl(DDS.CMDataWriterBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DDS.CMDataWriterBuiltinTopicDataSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DDS.CMDataWriterBuiltinTopicDataHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        DDS.CMDataWriterBuiltinTopicData instance)
    {
        long uReader = 0;
    ...
    {
        return new CMDataWriterBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
