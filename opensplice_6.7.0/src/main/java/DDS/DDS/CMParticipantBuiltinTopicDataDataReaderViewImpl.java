...
public class CMParticipantBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CMParticipantBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private CMParticipantBuiltinTopicDataTypeSupport typeSupport;

    public CMParticipantBuiltinTopicDataDataReaderViewImpl(DDS.CMParticipantBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
