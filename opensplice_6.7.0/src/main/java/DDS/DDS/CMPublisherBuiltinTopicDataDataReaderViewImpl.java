...
public class CMPublisherBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CMPublisherBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private CMPublisherBuiltinTopicDataTypeSupport typeSupport;

    public CMPublisherBuiltinTopicDataDataReaderViewImpl(DDS.CMPublisherBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
