...
public class SubscriptionBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements SubscriptionBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private SubscriptionBuiltinTopicDataTypeSupport typeSupport;

    public SubscriptionBuiltinTopicDataDataReaderViewImpl(DDS.SubscriptionBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
