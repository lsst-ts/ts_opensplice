...
public class TypeBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements TypeBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private TypeBuiltinTopicDataTypeSupport typeSupport;

    public TypeBuiltinTopicDataDataReaderViewImpl(DDS.TypeBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
