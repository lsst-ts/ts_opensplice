...
/**
 * Extension of {@link org.omg.dds.topic.TopicAdapter} to provide empty
 * implementation for onAllDataDisposed as well.
 */
public class TopicAdapter<TYPE> extends org.omg.dds.topic.TopicAdapter<TYPE>
     ...
     * @see org.opensplice.dds.topic.TopicListener
     * @see org.opensplice.dds.topic.Topic#disposeAllData()
     */
    @Override
    public void onAllDataDisposed(AllDataDisposedEvent<TYPE> status) {
    }
