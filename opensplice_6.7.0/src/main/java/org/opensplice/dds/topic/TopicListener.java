...
/**
 * Extension of {@link org.omg.dds.topic.TopicListener} to provide callback to
 * notify AllDataDisposedEvent as well.
 */
public interface TopicListener<TYPE> extends org.omg.dds.topic.TopicListener<TYPE> {
    /**
