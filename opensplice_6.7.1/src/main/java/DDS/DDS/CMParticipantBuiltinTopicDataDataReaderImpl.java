...
public class CMParticipantBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CMParticipantBuiltinTopicDataDataReader
{
    private long copyCache;
    private CMParticipantBuiltinTopicDataTypeSupport typeSupport;

    public CMParticipantBuiltinTopicDataDataReaderImpl(DDS.CMParticipantBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new CMParticipantBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
