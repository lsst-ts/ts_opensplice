...
public class TypeBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements TypeBuiltinTopicDataDataReader
{
    private long copyCache;
    private TypeBuiltinTopicDataTypeSupport typeSupport;

    public TypeBuiltinTopicDataDataReaderImpl(DDS.TypeBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            DDS.TypeBuiltinTopicDataSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            DDS.TypeBuiltinTopicDataHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        DDS.TypeBuiltinTopicData instance)
    {
        long uReader = 0;
    ...
    {
        return new TypeBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
