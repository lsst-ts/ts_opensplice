...
public class CMDataReaderBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CMDataReaderBuiltinTopicDataDataWriter
{
    private long copyCache;
    private CMDataReaderBuiltinTopicDataTypeSupport typeSupport;

    public CMDataReaderBuiltinTopicDataDataWriterImpl(DDS.CMDataReaderBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
