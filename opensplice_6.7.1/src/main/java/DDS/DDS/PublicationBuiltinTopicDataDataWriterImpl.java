...
public class PublicationBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PublicationBuiltinTopicDataDataWriter
{
    private long copyCache;
    private PublicationBuiltinTopicDataTypeSupport typeSupport;

    public PublicationBuiltinTopicDataDataWriterImpl(DDS.PublicationBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
