...
public class CMParticipantBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CMParticipantBuiltinTopicDataDataWriter
{
    private long copyCache;
    private CMParticipantBuiltinTopicDataTypeSupport typeSupport;

    public CMParticipantBuiltinTopicDataDataWriterImpl(DDS.CMParticipantBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
