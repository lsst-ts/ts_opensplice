...
public class ParticipantBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ParticipantBuiltinTopicDataDataReader
{
    private long copyCache;
    private ParticipantBuiltinTopicDataTypeSupport typeSupport;

    public ParticipantBuiltinTopicDataDataReaderImpl(DDS.ParticipantBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new ParticipantBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
