...
public class CMSubscriberBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CMSubscriberBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private CMSubscriberBuiltinTopicDataTypeSupport typeSupport;

    public CMSubscriberBuiltinTopicDataDataReaderViewImpl(DDS.CMSubscriberBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
