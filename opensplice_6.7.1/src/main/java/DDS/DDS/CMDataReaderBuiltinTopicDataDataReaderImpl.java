...
public class CMDataReaderBuiltinTopicDataDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements CMDataReaderBuiltinTopicDataDataReader
{
    private long copyCache;
    private CMDataReaderBuiltinTopicDataTypeSupport typeSupport;

    public CMDataReaderBuiltinTopicDataDataReaderImpl(DDS.CMDataReaderBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new CMDataReaderBuiltinTopicDataDataReaderViewImpl(typeSupport);
    }
}
