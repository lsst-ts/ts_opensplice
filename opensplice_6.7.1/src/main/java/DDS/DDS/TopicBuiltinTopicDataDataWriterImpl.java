...
public class TopicBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TopicBuiltinTopicDataDataWriter
{
    private long copyCache;
    private TopicBuiltinTopicDataTypeSupport typeSupport;

    public TopicBuiltinTopicDataDataWriterImpl(DDS.TopicBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
