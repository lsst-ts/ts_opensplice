...
public class ParticipantBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ParticipantBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private ParticipantBuiltinTopicDataTypeSupport typeSupport;

    public ParticipantBuiltinTopicDataDataReaderViewImpl(DDS.ParticipantBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
