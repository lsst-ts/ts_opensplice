...
public class PublicationBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PublicationBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private PublicationBuiltinTopicDataTypeSupport typeSupport;

    public PublicationBuiltinTopicDataDataReaderViewImpl(DDS.PublicationBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
