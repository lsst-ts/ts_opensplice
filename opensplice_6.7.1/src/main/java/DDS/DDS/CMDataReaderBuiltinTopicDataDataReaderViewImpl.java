...
public class CMDataReaderBuiltinTopicDataDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements CMDataReaderBuiltinTopicDataDataReaderView
{
    private long copyCache;
    private CMDataReaderBuiltinTopicDataTypeSupport typeSupport;

    public CMDataReaderBuiltinTopicDataDataReaderViewImpl(DDS.CMDataReaderBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
