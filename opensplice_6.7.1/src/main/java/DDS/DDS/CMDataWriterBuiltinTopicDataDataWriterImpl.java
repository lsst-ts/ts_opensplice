...
public class CMDataWriterBuiltinTopicDataDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements CMDataWriterBuiltinTopicDataDataWriter
{
    private long copyCache;
    private CMDataWriterBuiltinTopicDataTypeSupport typeSupport;

    public CMDataWriterBuiltinTopicDataDataWriterImpl(DDS.CMDataWriterBuiltinTopicDataTypeSupport ts)
    {
        typeSupport = ts;
